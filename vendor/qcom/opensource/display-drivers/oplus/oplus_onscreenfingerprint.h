...
struct oplus_ofp_params {
	...
	bool need_to_block_frame_after_aod_on;			/* indicates whether block frame after display on cmd(29h) be sent */
	bool block_frame_after_aod_on;					/* indicates whether to start block frame */
