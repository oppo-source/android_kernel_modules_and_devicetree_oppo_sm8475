...
static int oplus_display_update_dbv(struct dsi_panel *panel, unsigned int level);
		...
		struct mipi_dsi_device *dsi, u32 bl_lvl)
{
	...
	if ((!strcmp(panel->oplus_priv.vendor_name, "TM_NT37705")) && (bl_lvl > 1)) {
		oplus_display_update_dbv(panel, bl_lvl);
	}
...
static int oplus_display_update_dbv(struct dsi_panel *panel, unsigned int level)
{
	...
	for (i = 0; i < 3; i++) {
		...
		tx_buf[i+1] = ED_120[2];
		tx_buf = (char*)cmds[12].msg.tx_buf;
		tx_buf[i+1] = ED_90[0];
		tx_buf = (char*)cmds[14].msg.tx_buf;
		tx_buf[i+1] = ED_90[1];
		tx_buf = (char*)cmds[18].msg.tx_buf;
		tx_buf[i+1] = ED_144[0];
	...
	for (i = 0; i < 3; i++) {
		tx_buf = (char*)cmds[22].msg.tx_buf;
		tx_buf[i+1] = Frameskip_Vset_120[i];
		tx_buf = (char*)cmds[24].msg.tx_buf;
		tx_buf[i+1] = Frameskip_Vset_90[i];
		tx_buf = (char*)cmds[26].msg.tx_buf;
		tx_buf[i+1] = Frameskip_Vset_144[i];
	}
	...
	tx_buf = (char*)cmds[29].msg.tx_buf;
	tx_buf[0+1] = Voltage1;
	tx_buf = (char*)cmds[29].msg.tx_buf;
	tx_buf[1+1] = Voltage2;
	tx_buf = (char*)cmds[29].msg.tx_buf;
	...
	if(level > 0x643) {
		tx_buf = (char*)cmds[31].msg.tx_buf;
		tx_buf[0+1] = 0xB2;
		tx_buf = (char*)cmds[33].msg.tx_buf;
		tx_buf[0+1] = 0xB2;
		tx_buf = (char*)cmds[35].msg.tx_buf;
		tx_buf[0+1] = 0xB2;
		tx_buf = (char*)cmds[38].msg.tx_buf;
		tx_buf[0+1] = 0x02;
		tx_buf = (char*)cmds[38].msg.tx_buf;
		tx_buf[1+1] = 0x03;
		tx_buf = (char*)cmds[38].msg.tx_buf;
