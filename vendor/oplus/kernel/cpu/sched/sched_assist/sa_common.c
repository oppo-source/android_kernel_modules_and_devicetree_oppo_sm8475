...
enum chp_ext_vh_type {
        CHP_VH_CURRENT_IS_UX = MIGRATE_TYPES + 16,
        CHP_VH_FREE_ZRAM_IS_OK,
};

void android_vh_test_currect_ux_handler(void *unused, int migratetype, bool *is_ux)
{
	if (CHP_VH_CURRENT_IS_UX == migratetype)
