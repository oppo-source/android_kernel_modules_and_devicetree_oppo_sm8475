...
/* register vendor hook in kernel/futex.c */
void android_vh_alter_futex_plist_add_handler(void *unused, struct plist_node *node, struct plist_head *head, bool *already_on_hb);
