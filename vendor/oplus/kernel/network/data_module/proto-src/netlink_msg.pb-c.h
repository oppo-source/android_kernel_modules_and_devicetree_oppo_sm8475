...
typedef struct Netlink__Proto__RequestSetScene Netlink__Proto__RequestSetScene;
typedef struct Netlink__Proto__RequestSetCharater Netlink__Proto__RequestSetCharater;
typedef struct Netlink__Proto__RequestSetGameMainStreamUid Netlink__Proto__RequestSetGameMainStreamUid;
typedef struct Netlink__Proto__RequestSetWechatScene Netlink__Proto__RequestSetWechatScene;
typedef struct Netlink__Proto__RequestSetActivityScene Netlink__Proto__RequestSetActivityScene;
...
typedef struct Netlink__Proto__RequestSetDouyinIp Netlink__Proto__RequestSetDouyinIp;
...
typedef struct Netlink__Proto__ResponseDpiRecordItem Netlink__Proto__ResponseDpiRecordItem;
typedef struct Netlink__Proto__ResponseDpiRecordData Netlink__Proto__ResponseDpiRecordData;
...
typedef enum _Netlink__Proto__NetlinkMsgId {
  ...
  NETLINK__PROTO__NETLINK_MSG_ID__COMM_NETLINK_EVENT_SET_DPI_WECHAT_SCENE = 15,
  NETLINK__PROTO__NETLINK_MSG_ID__COMM_NETLINK_EVENT_GET_DPI_RECORD_DATA = 19,
...
struct  Netlink__Proto__RequestSetDpiUid
{
  ...
  protobuf_c_boolean has_zoomuid;
  uint32_t zoomuid;
  protobuf_c_boolean has_tencentmeetinguid;
  uint32_t tencentmeetinguid;
  protobuf_c_boolean has_wechatuid;
  uint32_t wechatuid;
  protobuf_c_boolean has_douyuuid;
  uint32_t douyuuid;
  protobuf_c_boolean has_huyauid;
  uint32_t huyauid;
  protobuf_c_boolean has_youkuuid;
  uint32_t youkuuid;
  protobuf_c_boolean has_iqiyiuid;
  uint32_t iqiyiuid;
  protobuf_c_boolean has_bilibiliuid;
  uint32_t bilibiliuid;
  protobuf_c_boolean has_douyinuid;
  uint32_t douyinuid;
  protobuf_c_boolean has_kuaishouuid;
  uint32_t kuaishouuid;
  protobuf_c_boolean has_qquid;
  uint32_t qquid;
};
...
struct  Netlink__Proto__RequestSetScene
{
  ProtobufCMessage base;
  uint32_t uid;
  uint32_t scene;
...
#define NETLINK__PROTO__REQUEST_SET_SCENE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__request_set_scene__descriptor) \
    , 0, 0, 0 }


struct  Netlink__Proto__RequestSetCharater
{
  ProtobufCMessage base;
  uint64_t streamid;
...
#define NETLINK__PROTO__REQUEST_SET_CHARATER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__request_set_charater__descriptor) \
...
struct  Netlink__Proto__RequestSetWechatScene
{
  ProtobufCMessage base;
  uint64_t wechatscene PROTOBUF_C__DEPRECATED;
  uint32_t isenter PROTOBUF_C__DEPRECATED;
};
#define NETLINK__PROTO__REQUEST_SET_WECHAT_SCENE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__request_set_wechat_scene__descriptor) \
    , 0, 0 }


struct  Netlink__Proto__RequestSetActivityScene
{
  ProtobufCMessage base;
  protobuf_c_boolean has_douyinstreamid;
  uint64_t douyinstreamid;
  protobuf_c_boolean has_kuaishoustreamid;
  uint64_t kuaishoustreamid;
};
#define NETLINK__PROTO__REQUEST_SET_ACTIVITY_SCENE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__request_set_activity_scene__descriptor) \
    , 0, 0, 0, 0 }
...
struct  Netlink__Proto__RequestSetDouyinIp
{
  ProtobufCMessage base;
  char *hostname;
  size_t n_ipaddr;
...
#define NETLINK__PROTO__REQUEST_SET_DOUYIN_IP__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__request_set_douyin_ip__descriptor) \
    , NULL, 0,NULL, 0,NULL }
...
typedef enum {
  ...
  NETLINK__PROTO__REQUEST_MESSAGE__REQUEST_DATA_REQUEST_SET_WECHAT_SCENE = 17,
  NETLINK__PROTO__REQUEST_MESSAGE__REQUEST_DATA_REQUEST_SET_SCENE = 18,
  NETLINK__PROTO__REQUEST_MESSAGE__REQUEST_DATA_REQUEST_SET_CHARATER = 19,
  NETLINK__PROTO__REQUEST_MESSAGE__REQUEST_DATA_REQUEST_SET_ACTIVITY_SCENE = 20,
  NETLINK__PROTO__REQUEST_MESSAGE__REQUEST_DATA_REQUEST_SET_DOUYIN_IP = 21
...
struct  Netlink__Proto__RequestMessage
{
  ...
  union {
    ...
    Netlink__Proto__RequestSetWechatScene *requestsetwechatscene;
    Netlink__Proto__RequestSetScene *requestsetscene;
    Netlink__Proto__RequestSetCharater *requestsetcharater;
    Netlink__Proto__RequestSetActivityScene *requestsetactivityscene;
    Netlink__Proto__RequestSetDouyinIp *requestsetdouyinip;
  };
};
...
struct  Netlink__Proto__ResponseDpiRecordItem
{
  ProtobufCMessage base;
  uint64_t dpi_id;
  uint64_t duration;
...
#define NETLINK__PROTO__RESPONSE_DPI_RECORD_ITEM__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__response_dpi_record_item__descriptor) \
    , 0, 0, 0, 0, 0 }


struct  Netlink__Proto__ResponseDpiRecordData
{
  ProtobufCMessage base;
  size_t n_recorddata;
  Netlink__Proto__ResponseDpiRecordItem **recorddata;
};
#define NETLINK__PROTO__RESPONSE_DPI_RECORD_DATA__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__response_dpi_record_data__descriptor) \
    , 0,NULL }
...
typedef enum {
  ...
  NETLINK__PROTO__RESPONSE_MESSAGE__RESPONSE_DATA_RESPONSE_DPI_RECORD_DATA = 14
...
struct  Netlink__Proto__ResponseMessage
{
  ...
  union {
    ...
    Netlink__Proto__ResponseDpiRecordData *responsedpirecorddata;
  };
};
...
void   netlink__proto__request_set_dpi_uid__free_unpacked
                     (Netlink__Proto__RequestSetDpiUid *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__RequestSetScene methods */
...
void   netlink__proto__request_set_scene__free_unpacked
                     (Netlink__Proto__RequestSetScene *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__RequestSetCharater methods */
...
void   netlink__proto__request_set_game_main_stream_uid__free_unpacked
                     (Netlink__Proto__RequestSetGameMainStreamUid *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__RequestSetWechatScene methods */
...
void   netlink__proto__request_set_wechat_scene__free_unpacked
                     (Netlink__Proto__RequestSetWechatScene *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__RequestSetActivityScene methods */
...
void   netlink__proto__request_set_log_steam_ip__free_unpacked
                     (Netlink__Proto__RequestSetLogSteamIp *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__RequestSetDouyinIp methods */
...
void   netlink__proto__response_get_game_delay__free_unpacked
                     (Netlink__Proto__ResponseGetGameDelay *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__ResponseDpiRecordItem methods */
...
void   netlink__proto__response_dpi_record_item__free_unpacked
                     (Netlink__Proto__ResponseDpiRecordItem *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__ResponseDpiRecordData methods */
...
typedef void (*Netlink__Proto__RequestSetDpiUid_Closure)
                 (const Netlink__Proto__RequestSetDpiUid *message,
                  void *closure_data);
typedef void (*Netlink__Proto__RequestSetScene_Closure)
                 (const Netlink__Proto__RequestSetScene *message,
                  void *closure_data);
typedef void (*Netlink__Proto__RequestSetCharater_Closure)
                 (const Netlink__Proto__RequestSetCharater *message,
                  void *closure_data);
typedef void (*Netlink__Proto__RequestSetGameMainStreamUid_Closure)
                 (const Netlink__Proto__RequestSetGameMainStreamUid *message,
                  void *closure_data);
typedef void (*Netlink__Proto__RequestSetWechatScene_Closure)
                 (const Netlink__Proto__RequestSetWechatScene *message,
                  void *closure_data);
typedef void (*Netlink__Proto__RequestSetActivityScene_Closure)
                 (const Netlink__Proto__RequestSetActivityScene *message,
                  void *closure_data);
...
typedef void (*Netlink__Proto__RequestSetLogSteamIp_Closure)
                 (const Netlink__Proto__RequestSetLogSteamIp *message,
                  void *closure_data);
typedef void (*Netlink__Proto__RequestSetDouyinIp_Closure)
                 (const Netlink__Proto__RequestSetDouyinIp *message,
                  void *closure_data);
...
typedef void (*Netlink__Proto__ResponseGetGameDelay_Closure)
                 (const Netlink__Proto__ResponseGetGameDelay *message,
                  void *closure_data);
typedef void (*Netlink__Proto__ResponseDpiRecordItem_Closure)
                 (const Netlink__Proto__ResponseDpiRecordItem *message,
                  void *closure_data);
typedef void (*Netlink__Proto__ResponseDpiRecordData_Closure)
                 (const Netlink__Proto__ResponseDpiRecordData *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor netlink__proto__request_set_scene__descriptor;
extern const ProtobufCMessageDescriptor netlink__proto__request_set_charater__descriptor;
extern const ProtobufCMessageDescriptor netlink__proto__request_set_game_main_stream_uid__descriptor;
extern const ProtobufCMessageDescriptor netlink__proto__request_set_wechat_scene__descriptor;
extern const ProtobufCMessageDescriptor netlink__proto__request_set_activity_scene__descriptor;
...
extern const ProtobufCMessageDescriptor netlink__proto__request_set_douyin_ip__descriptor;
...
extern const ProtobufCMessageDescriptor netlink__proto__response_dpi_record_item__descriptor;
extern const ProtobufCMessageDescriptor netlink__proto__response_dpi_record_data__descriptor;
