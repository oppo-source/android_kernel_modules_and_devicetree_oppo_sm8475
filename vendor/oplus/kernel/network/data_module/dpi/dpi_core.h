...
#define TRAFFIC_UNIT 1024
#define DPI_STREAM_MASK 0xFFFF
...
typedef struct {
	...
	union {
		...
		dpi_wechat_data wechat_data;
		dpi_bilibili_data bilibili_data;
		dpi_qq_data qq_data;
		dpi_kuaishou_data kuaishou_data;
		dpi_douyin_data douyin_data;
	};
} dpi_match_data_t;
...
typedef struct {
	struct hlist_node uid_tree_node;
	struct hlist_node stream_tree_node;
	struct hlist_node list_node;
	dpi_result_node *uid_result_node;
	dpi_result_node *stream_result_node;
