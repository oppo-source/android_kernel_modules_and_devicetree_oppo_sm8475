...
def define_oplus_local_modules():
    ...
    define_oplus_ddk_module(
        ...
        srcs = native.glob([
            ...
            "data_module/dpi/douyu.c",
            "data_module/dpi/huya.c",
            "data_module/dpi/youku.c",
            "data_module/dpi/iqiyi.c",
            "data_module/dpi/bilibili.c",
            "data_module/dpi/douyin.c",
            "data_module/dpi/kuaishou.c",
            "data_module/dpi/qq.c",
